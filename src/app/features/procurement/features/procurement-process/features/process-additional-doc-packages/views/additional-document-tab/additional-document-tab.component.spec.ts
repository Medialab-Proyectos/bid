...
import { DocumentDetailComponent } from '../../../process-doc-packages/components/document-detail/document-detail.component';
...
import { AdditionalDocumentTabComponent } from './additional-document-tab.component';
import {
  TablesModule,
  AccordionModule,
  PipeModule,
...
import { PackageDocComponent } from '../../../process-doc-packages/components/package-doc/package-doc.component';
...
describe('AdditionalDocumentTabComponent', () => {
...
async function setup(mobileView = false, empty = false) {
  ...
  const { fixture } = await render(AdditionalDocumentTabComponent, {
    componentProperties: {
      isEnumLoaded: true,
    },
    declarations: [
