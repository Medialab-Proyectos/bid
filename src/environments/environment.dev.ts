...
const baseURL = 'https://dev-fiduciaryinterface.iadb.org/';
...
export const environment = {
  ...
  hostApi: {
    fiduciaryProcessApi: {
      endpoint:
        'https://apim-np-d-idb-integration.iadb.org/ext/process/cnvg/business/fp',
      scope: '',
    },
  },
  helpSupportUrl: 'https://clientportal-dev.iadb.org/help',
  openId: {
    authority:
  ...
  ScopesB2C: {
    Locale: [
      'openid',
      'profile',
      'https://idbgextt.onmicrosoft.com/1e083f7f-3711-41cf-af74-26776a7d798e/Locale.Read',
    ],
    FiduciaryProcess: [
      'openid',
      'profile',
