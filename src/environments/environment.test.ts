...
const baseURL = 'https://test-fiduciaryinterface.iadb.org/';
...
export const environment = {
  ...
  hostApi: {
    fiduciaryProcessApi: {
      endpoint:
        'https://apim-np-t-idb-integration.iadb.org/ext/process/cnvg/business/fp',
      scope: '',
    },
  },
  ...
  clientsConnectivityPortalUrl: 'http://clientportal-test.iadb.org/',
